// src/pages/Expertise.js - VERSION PROFESSIONNELLE COMPLÈTE
...
const API_BASE = '/api/expertise/api';
    ...
    <div style={{
      ...
      <form onSubmit={handleSubmit}>
        <h2 style={{
          ...
          Scraping des Marchés Publics Tunisiens EXPERTISE FRANCE
        </h2>
        ...
        <div style={{
          ...
          >
            {loading ? (
              ...
              <>
                <Play size={20} />
                Lancer le Scraping EXPERTISE FRANCE
              </>
            )}
          </button>
  ...
  return (
    <div style={{
      ...
      <h2 style={{
        ...
        ⏳ Offres en Attente EXPERTISE FRANCE
        <span style={{
  ...
  return (
    <div style={{
      ...
      <h2 style={{
        ...
        ✅ Offres Validées EXPERTISE FRANCE
        <span style={{
          background: 'linear-gradient(135deg, #27ae60 0%, #219653 100%)',
          color: 'white',
          padding: '0.25rem 0.75rem',
...
const Expertise = () => {
  ...
  const fetchHealth = async () => {
    try {
      ...
      if (response.data.error) {
        setError('⚠️ Service EXPERTISE FRANCE non disponible');
      } else {
        setError('');
      }
    } catch (err) {
      setHealth({ error: err.message });
      setError('❌ Erreur de connexion au serveur EXPERTISE FRANCE');
    }
  };
  ...
  const handleScrape = async (formData) => {
    ...
    setError('');
    try {
      const response = await axios.post(`${API_BASE}/scrape`, formData);
      
      if (response.data.success) {
        alert('✅ Scraping EXPERTISE FRANCE démarré avec succès! Rafraîchissez dans quelques minutes.');
        setProcessing(true);
        ...
        setTimeout(() => {
          ...
          setProcessing(false);
        }, 180000); // 3 minutes pour EXPERTISE FRANCE
      } else {
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        <div style={{
          ...
          <h1 style={{
            ...
            🇹🇳 Scraper EXPERTISE FRANCE Tunisie
          </h1>
          <p style={{ color: '#64748B', fontSize: '1.1rem' }}>
            Extraction automatique des marchés publics tunisiens (EXPERTISE FRANCE)
          </p>
        </div>
